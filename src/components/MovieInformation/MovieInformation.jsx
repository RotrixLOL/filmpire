...
import { useGetRecommendationsQuery, useGetMovieQuery, useGetListQuery } from '../../redux/services/TMDB';
...
const MovieInformation = () => {
  ...
  const { data, isFetching: isLoading, error } = useGetMovieQuery(id);
  ...
  return (
    <Grid container className={classes.containerSpaceAround}>
      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Typography variant="h5" gutterBotttom>Top Cast</Typography>
          ...
          <div className={classes.buttonsContainer}>
            <Grid item xs={12} sm={6} className={classes.buttonsContainer}>
              <ButtonGroup size="medium" variant="outlined">
                <Button target="_blank" rel="noopener nore" href={data?.homepage} endIcon={<Language />}>Website</Button>
                <Button target="_blank" rel="noopener nore" href={`https://www.imdb.com/title/${data?.imdb_id}`} endIcon={<MovieIcon />}>IMDB</Button>
